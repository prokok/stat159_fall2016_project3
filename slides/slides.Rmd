...
- Data provided on every insitution in America by the US Department of Education
...
- ... and over 7,700 individual schools (rows), resulting in an unmangeably gigantic dataset
...
- Restricted results to only "selective" or "highly selective" four-year instituions
...
## Results | Underperfoming Schools with Lowest Cost of Attendance (Black){.flexbox .vcenter}
...
## Results | Underperfoming Schools with Lowest Cost of Attendance (Hispanic) {.flexbox .vcenter}
...
## Results | Underperfoming Schools with Lowest Median Debt (Black) {.flexbox .vcenter}
...
## Results | Underperfoming Schools with Lowest Median Debt (Hispanic) {.flexbox .vcenter}
...
- The Previous lists of schools represent insitutions not doing as well as expected when it comes to graduating their minority students
