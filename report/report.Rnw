...
library(xtable)
print(xtable(head(over3_black[,c(1,4)], 35), caption="Top 20 Most Underperforming Qualified Schools for Black Students", align = "llc"), table.placement="H", include.rownames = FALSE, caption.placement = 'top', center = "centering")
@
\end{center}
...
<<xtest, echo=false, results=tex>>=
library(xtable)
print(xtable(head(over3_hisp[,c(1,4)], 35), caption="Top 20 Most Underperforming Qualified Schools for Hispanic Students", align = "llc"), table.placement="H", include.rownames = FALSE, caption.placement = 'top', center = "centering")
@
\end{center}
